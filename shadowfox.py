...
# 2.1 Format function example (octal)
num = 145
formatted = format(num, 'o')
print("Octal representation of 145:", formatted)

# 2.2 Area of Circular Pond & Total Water
radius = 84
pi = 3.14
area = pi * (radius ** 2)
water_per_sqm = 1.4
